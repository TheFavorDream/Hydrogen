/*
	Definition and Implementation for the Hydrogen's dynamic matrix.

	note: prefer to use "Predefined" matrices when it's possible 	
*/
...
#include "Predefined/Mat4/Mat4.h"
#include "Predefined/Mat3/Mat3.h"
#include "Predefined/Mat2/Mat2.h"
